      ...
      <div className="space-y-3 mb-4 bg-white/60 backdrop-blur-sm rounded-xl p-4 border border-blue-100">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <a
              href="mailto:suport@gradinita.app"
...
function FAQCard() {
  ...
  const faqs = [
    {
      ...
      answer:
        "Click pe 'Import SIIIR' din dashboard → Upload fișierul .xls exportat din SIIIR → Verifică preview → Confirmă import. Grupele și copiii se creează automat!",
    },
    {
      question: "Cum adaug detalii părinți?",
      answer:
        "Click pe un copil → Editează → Secțiunea 'Părinte 1/2' → Completează nume, telefon, email, CNP → Salvează. Părintele va primi acces la dashboard.",
    },
    {
      question: "Cum marchează educatoarea prezența?",
      answer:
        "Educatoarea → Login → Click 'Prezență' → Bifează copiii prezenți → Salvează. Prezența se actualizează automat în dashboard.",
    },
    {
      question: "Cum generez rapoarte financiare?",
      answer:
        "Dashboard → 'Raport Financiar TOTAL' sau 'Raport Financiar GRUPE' → Selectează luna → Vezi încasări, restanțe, statistici → Export Excel/PDF.",
    },
    {
      question: "Cum adaug un copil manual?",
      answer:
        "Dashboard grădiniță → 'Adaugă Copil' → Completează CNP, nume, grupă, date părinți, contract → Salvează. Copilul apare instant în sistem.",
    },
  ];
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-pink-50 rounded-3xl p-6 shadow-[0_8px_0_rgba(59,130,246,0.3),0_12px_24px_rgba(59,130,246,0.2)] hover:shadow-[0_4px_0_rgba(59,130,246,0.4),0_8px_20px_rgba(59,130,246,0.3)] hover:translate-y-1 transition-all duration-200 border-2 border-blue-200">
      ...
      <p className="text-gray-600 text-sm mb-4 font-medium">
        Ghid rapid pentru funcționalități
      </p>
...
export default function GradinitaDashboard({
  locations,
  onDelete,
}: GradinitaDashboardProps) {
  const totalCapacity = locations.reduce(
    (sum, loc) => sum + (loc.capacity || 0),
    0,
  );
  const totalChildren = locations.reduce(
    (sum, loc) => sum + (loc.childrenCount || 0),
    0,
  );
    ...
    try {
      ...
      setProcentPrezenta(
        totalChildrenCount > 0
          ? Math.round((totalPresent / totalChildrenCount) * 100)
          : 0,
      );
    } catch (error) {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-gradient-to-br from-pink-500 to-pink-600 rounded-3xl p-5 shadow-[0_8px_0_rgb(236,72,153),0_13px_25px_rgba(236,72,153,0.4)] hover:shadow-[0_4px_0_rgb(236,72,153),0_8px_20px_rgba(236,72,153,0.5)] hover:translate-y-1 transition-all duration-200 border-2 border-pink-400">
          ...
          <h3 className="text-pink-100 text-xs font-semibold mb-1">
            Capacitate Totală
          </h3>
        ...
        <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-3xl p-5 shadow-[0_8px_0_rgb(22,163,74),0_13px_25px_rgba(22,163,74,0.4)] hover:shadow-[0_4px_0_rgb(22,163,74),0_8px_20px_rgba(22,163,74,0.5)] hover:translate-y-1 transition-all duration-200 border-2 border-green-400">
          ...
          <h3 className="text-green-100 text-xs font-semibold mb-1">
            Copii Înscriși
          </h3>
        ...
        <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-3xl p-5 shadow-[0_8px_0_rgb(147,51,234),0_13px_25px_rgba(147,51,234,0.4)] hover:shadow-[0_4px_0_rgb(147,51,234),0_8px_20px_rgba(147,51,234,0.5)] hover:translate-y-1 transition-all duration-200 border-2 border-purple-400">
          ...
          <h3 className="text-purple-100 text-xs font-semibold mb-1">
            Prezență Azi
          </h3>
          <p className="text-sm text-purple-50">
            {prezentiAzi} din {totalChildren} copii
          </p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-xl p-6 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Link href="/reports/financial" className="group relative">
          ...
          <Link href="/reports/financial-groups" className="group relative">
          ...
          <Link href="/dashboard/mesaje" className="group relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div>
          ...
          {/* Buton Adaugă Grădiniță - vizibil DOAR când nu există nicio locație */}
          {locations.length === 0 && (
            <div className="bg-gradient-to-br from-blue-50 via-white to-pink-50 rounded-3xl p-8 shadow-[0_8px_0_rgba(59,130,246,0.3),0_12px_24px_rgba(59,130,246,0.2)] border-2 border-blue-200 text-center">
              ...
              <p className="text-gray-600 mb-6">
                Adaugă grădinița ta pentru a începe
              </p>
              <Link
                href="/gradinite/add"
                className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl font-bold hover:from-blue-700 hover:to-blue-800 transition shadow-lg hover:shadow-xl"
              >
            ...
            >
              ...
              <div className="space-y-2 mb-5 bg-white/60 backdrop-blur-sm rounded-xl p-3 border border-blue-100">
                <p className="text-gray-700 text-sm font-semibold flex items-center gap-2">
                  <span className="text-lg">👶</span> Capacitate:{" "}
                  <span className="text-blue-600">
                    {location.capacity || 0} copii
                  </span>
                </p>
                <p className="text-gray-700 text-sm font-semibold flex items-center gap-2">
                  <span className="text-lg">✅</span> Înscriși:{" "}
                  <span className="text-green-600">
                    {location.childrenCount || 0} copii
                  </span>
                </p>
                <p className="text-gray-700 text-sm font-semibold flex items-center gap-2">
                  <span className="text-lg">🎨</span> Total Grupe:{" "}
                  <span className="text-purple-600">
                    {location.grupe?.length || 0}
                  </span>
                </p>
                {location.program && (
                  <p className="text-gray-700 text-sm font-semibold flex items-center gap-2">
                    <span className="text-lg">🕐</span> Program:{" "}
                    <span className="text-pink-600">
                      {location.program} ({location.programOraStart || "08:00"}{" "}
                      - {location.programOraEnd || "16:00"})
                    </span>
                  </p>
                )}
              </div>
